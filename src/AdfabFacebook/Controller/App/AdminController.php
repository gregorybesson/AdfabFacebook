...
namespace AdfabFacebook\Controller\App;
...
class AdminController extends AbstractActionController
{
    ...
    public function createAction()
    {
        ...
        $viewModel->setTemplate('adfab-facebook/admin/app');
    ...
    public function getOptions()
    {
        if (!$this->options instanceof ModuleOptions) {
            $this->setOptions($this->getServiceLocator()->get('adfabfacebook_module_options'));
        }
    ...
    public function getAppMapper()
    {
        if (null === $this->appMapper) {
            $this->appMapper = $this->getServiceLocator()->get('adfabfacebook_app_mapper');
        }
    ...
    public function getAdminAppService()
    {
        if (null === $this->adminAppService) {
            $this->adminAppService = $this->getServiceLocator()->get('adfabfacebook_app_service');
        }
